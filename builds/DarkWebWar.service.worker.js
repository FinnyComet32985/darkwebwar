...
/** @type {string} */
const CACHE_VERSION = '1745840889|76704573';
/** @type {string} */
const CACHE_PREFIX = 'DarkWebWar-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'DarkWebWar.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["DarkWebWar.html","DarkWebWar.js","DarkWebWar.offline.html","DarkWebWar.icon.png","DarkWebWar.apple-touch-icon.png","DarkWebWar.audio.worklet.js","DarkWebWar.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["DarkWebWar.wasm","DarkWebWar.pck"];
